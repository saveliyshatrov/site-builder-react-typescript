...
export default class MarginCard extends Component<any, any> {
    state = {
        all:{
            top: this.props.obj.all.margin.length === 1?parseInt(this.props.obj.all.margin[0].replace('px', '').replace('%', '')):parseInt(this.props.obj.all.margin[0].replace('px', '').replace('%', '')),
            right: this.props.obj.all.margin.length === 1?parseInt(this.props.obj.all.margin[0].replace('px', '').replace('%', '')):parseInt(this.props.obj.all.margin[1].replace('px', '').replace('%', '')),
            bottom: this.props.obj.all.margin.length === 1?parseInt(this.props.obj.all.margin[0].replace('px', '').replace('%', '')):parseInt(this.props.obj.all.margin[2].replace('px', '').replace('%', '')),
            left: this.props.obj.all.margin.length === 1?parseInt(this.props.obj.all.margin[0].replace('px', '').replace('%', '')):parseInt(this.props.obj.all.margin[3].replace('px', '').replace('%', '')),
            typeSize: this.props.obj.all.margin[0].includes('%')?'%':'px',
            all: this.props.obj.all.margin.length === 1
        },
        mobile: {
            top: this.props.obj.mobile.margin.length === 1?parseInt(this.props.obj.mobile.margin[0].replace('px', '').replace('%', '')):parseInt(this.props.obj.mobile.margin[0].replace('px', '').replace('%', '')),
            right: this.props.obj.mobile.margin.length === 1?parseInt(this.props.obj.mobile.margin[0].replace('px', '').replace('%', '')):parseInt(this.props.obj.mobile.margin[1].replace('px', '').replace('%', '')),
            bottom: this.props.obj.mobile.margin.length === 1?parseInt(this.props.obj.mobile.margin[0].replace('px', '').replace('%', '')):parseInt(this.props.obj.mobile.margin[2].replace('px', '').replace('%', '')),
            left: this.props.obj.mobile.margin.length === 1?parseInt(this.props.obj.mobile.margin[0].replace('px', '').replace('%', '')):parseInt(this.props.obj.mobile.margin[3].replace('px', '').replace('%', '')),
            typeSize: this.props.obj.mobile.margin[0].includes('%')?'%':'px',
            all: this.props.obj.mobile.margin.length === 1
        },
        tablet: {
            top: this.props.obj.tablet.margin.length === 1?parseInt(this.props.obj.tablet.margin[0].replace('px', '').replace('%', '')):parseInt(this.props.obj.tablet.margin[0].replace('px', '').replace('%', '')),
            right: this.props.obj.tablet.margin.length === 1?parseInt(this.props.obj.tablet.margin[0].replace('px', '').replace('%', '')):parseInt(this.props.obj.tablet.margin[1].replace('px', '').replace('%', '')),
            bottom: this.props.obj.tablet.margin.length === 1?parseInt(this.props.obj.tablet.margin[0].replace('px', '').replace('%', '')):parseInt(this.props.obj.tablet.margin[2].replace('px', '').replace('%', '')),
            left: this.props.obj.tablet.margin.length === 1?parseInt(this.props.obj.tablet.margin[0].replace('px', '').replace('%', '')):parseInt(this.props.obj.tablet.margin[3].replace('px', '').replace('%', '')),
            typeSize: this.props.obj.tablet.margin[0].includes('%')?'%':'px',
            all: this.props.obj.tablet.margin.length === 1
        },
        desktop: {
            top:      this.props.obj.desktop.margin.length === 1?parseInt(this.props.obj.desktop.margin[0].replace('px', '').replace('%', '')):parseInt(this.props.obj.desktop.margin[0].replace('px', '').replace('%', '')),
            right:    this.props.obj.desktop.margin.length === 1?parseInt(this.props.obj.desktop.margin[0].replace('px', '').replace('%', '')):parseInt(this.props.obj.desktop.margin[1].replace('px', '').replace('%', '')),
            bottom:   this.props.obj.desktop.margin.length === 1?parseInt(this.props.obj.desktop.margin[0].replace('px', '').replace('%', '')):parseInt(this.props.obj.desktop.margin[2].replace('px', '').replace('%', '')),
            left:     this.props.obj.desktop.margin.length === 1?parseInt(this.props.obj.desktop.margin[0].replace('px', '').replace('%', '')):parseInt(this.props.obj.desktop.margin[3].replace('px', '').replace('%', '')),
            typeSize: this.props.obj.desktop.margin[0].includes('%')?'%':'px',
            all:      this.props.obj.desktop.margin.length === 1
        },
        mob: false,
        tab: false,
        des: false,
